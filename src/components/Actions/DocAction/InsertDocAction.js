...
export const InsertDocAction = ({selectedDataRow, closeModalInsert }) => {
    ...
    const handleInsert = async () => {
        ...
        if (data._status === ''|| data._action === '' || data.fileName === ''|| !inputFile) {
            handleShowError();
            return;
        }
    ...
    return (
        <Modal
            title={`Insertar documento en acción: ${selectedDataRow.action_name}`}
            body={
                <div className="card card-primary ">
                    <div className="card-header">
                        <h3 className="card-title">Datos de documento</h3>
