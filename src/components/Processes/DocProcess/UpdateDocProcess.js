...
export const UpdateDocProcess = ({ selectedDataRow, closeModalEdit }) => {
    ...
    const handleUpdate = async () => {
        ...
        if (data._status === '' || data._process === '' || data.fileName === '' ) {
            handleShowError();
            return;
        }
    ...
    return (
        <Modal
            title={`Editar documento del proceso: ${selectedDataRow.process_name}`}
            body={
