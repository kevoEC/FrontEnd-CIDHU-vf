...
import { InsertDocProcess } from './InsertDocProcess';
import { UpdateDocProcess } from './UpdateDocProcess';
import { AuthContext } from '../../Context/AuthContext';


export const DocProcess = ({ selectedDataRow, closeTabsDocArticle, handleReload }) => {
    ...
    const fetchDataList = async () => {
        try {
            ...
            const responseData = await fetchJson(
                'http://localhost:3000/app/apiFile/apiFile.php/listFileProcess',
                requestData
            );
                ...
                <div className="col-12">
                    <div className="card card-warning">
                        <div className="card-header">
                            <h3 className="card-title">Documento de proceso: <strong>{selectedDataRow.process_name}</strong></h3>
                        ...
                        {showModalUpdate && (
                            <UpdateDocProcess selectedDataRow={selectedDataRow2} closeModalEdit={closeModalEdit} />
                        )}
                        {showModalInsert && (
                            <InsertDocProcess selectedDataRow={selectedDataRow} closeModalInsert={closeModalInsert} />
                        )}
