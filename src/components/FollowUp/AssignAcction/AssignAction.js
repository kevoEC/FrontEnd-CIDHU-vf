    ...
    const fetchDataList = async () => {
        try {
            ...
            const responseData = await fetchJson(
                'http://localhost:3000/app/apiArticleAction/apiArticleAction.php/listArticleAction',
                requestData
            );
                ...
                <div className="col-12">
                    <div className="card card-success">
                        <div className="card-header">
                            <h3 className="card-title">Asignar acción a artículo: <strong>{selectedDataRow.article_name}</strong></h3>
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                {currentRecords.map((data) => (
                                                    <tr key={`${data.article_id}-${data.action_id}`}>
