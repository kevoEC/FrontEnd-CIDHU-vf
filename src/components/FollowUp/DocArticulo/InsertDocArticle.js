...
export const InsertDocArticle = ({ selectedDataRow, closeModalInsert }) => {
    ...
    const handleInsert = async () => {
        ...
        if (data._status === '' || data.fileName === '' || !inputFile) {
            handleShowError();
            return;
        }
    ...
    return (
        <Modal
            title={`Insertar documento en articulo: ${selectedDataRow.article_name}`}
            body={
