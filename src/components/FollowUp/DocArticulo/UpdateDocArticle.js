...
export const UpdateDocArticle = ({ selectedDataRow, closeModalEdit }) => {
    ...
    return (
        <Modal
            title={`Modificar documento de articulo: ${selectedDataRow.article_name}`}
            body={
