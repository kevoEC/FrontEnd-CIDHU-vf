...
import { UpdateAssignProcess } from './UpdateAssignProcess';
import { InsertAssignProcess } from './InsertAssignProcess';
import { DeleteAssignProcess } from './DeleteAssignProcess';
import { AuthContext } from '../../Context/AuthContext';


export const AssignProcess = ({ selectedDataRow, closeTabsAssign, handleReload }) => {
    ...
    const fetchDataList = async () => {
        try {
            ...
            const responseData = await fetchJson(
                'http://localhost:3000/app/apiArticleProcess/apiArticleProcess.php/listArticleProcess',
                requestData
            );
                ...
                <div className="col-12">
                    <div className="card card-danger">
                        <div className="card-header">
                            <h3 className="card-title">Asignar proceso a artíclo: <strong>{selectedDataRow.article_name}</strong></h3>
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                {currentRecords.map((data) => (
                                                    <tr key={`${data.article_id}-${data.process_id}`}>
                        ...
                        {showModalUpdate && (
                            <UpdateAssignProcess selectedDataRow={selectedDataRow2} closeModalEdit={closeModalEdit} />
                        )}
                        {showModalInsert && (
                            <InsertAssignProcess selectedDataRow={selectedDataRow} closeModalInsert={closeModalInsert} />
                        )}
                         {showModalDelete && (
                            <DeleteAssignProcess selectedDataRow={selectedDataRow2} closeModalDelete={closeModalDelete} />
                        )}
