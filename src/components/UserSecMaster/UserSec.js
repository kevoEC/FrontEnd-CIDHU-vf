...
import { UpdateUserSec } from './UpdateUserSec';
import { InsertUserSec } from './InsertUserSec';
import { SearchUserSec } from './SearchUserSec';
...
export const UserSec = () => {
    ...
    return (
        ...
        <div>
            ...
            <SearchUserSec dataTable={dataTable} onChangeFilter={onChangeFilter} />
            ...
            {showModalUpdate && (
                <UpdateUserSec selectedDataRow={selectedDataRow} closeModalEdit={closeModalEdit} />
            )}
            {showModalInsert && (
                <InsertUserSec closeModalInsert={closeModalInsert} />
            )}
        </div >
    );
};
